...
class Level5 : Level {
    ...
    private val piece2 = GamePiece(PieceType.RED, 3)
    private val piece3 = GamePiece(PieceType.RED, 3, 90F)
    private val piece4 = GamePiece(PieceType.YELLOW)
    private val piece5 = GamePiece(PieceType.EMPTY)
    private val piece6 = GamePiece(PieceType.RED, 3, 270F)
    private val piece7 = GamePiece(PieceType.RED, 3, 180F)
    private val piece8 = GamePiece(PieceType.EMPTY)
    ...
    private val piece14 = GamePiece(PieceType.BLUE, 1)
    private val piece15 = GamePiece(PieceType.BLUE, 1, 180F)
