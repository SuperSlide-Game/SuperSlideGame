...
class Level1 : Level {
    ...
    private val piece10 = GamePiece(PieceType.BLUE, 1, PieceType.BLUE.imgSrc, 0f)
    private val piece11 = GamePiece(PieceType.BLUE, 1, PieceType.BLUE.imgSrc,180f)
    private val piece12 = GamePiece(PieceType.YELLOW)
    private val piece13 = GamePiece(PieceType.RED, 3,PieceType.RED.imgSrc,0f)
    private val piece14 = GamePiece(PieceType.RED, 3,PieceType.RED.imgSrc,90f)
    private val piece15 = GamePiece(PieceType.BLUE, 2,PieceType.BLUE.imgSrc,90f)
    private val piece16 = GamePiece(PieceType.YELLOW)
    private val piece17 = GamePiece(PieceType.RED, 3,PieceType.RED.imgSrc,270f)
    private val piece18 = GamePiece(PieceType.RED, 3,PieceType.RED.imgSrc,180f)
    private val piece19 = GamePiece(PieceType.BLUE, 2,PieceType.BLUE.imgSrc,270f)
